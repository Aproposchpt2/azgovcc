'use strict';
// CalGCC â€” Arizona Bid Proposal Writer (Claude Sonnet)
// POST { bid, business, services } â†’ { ok, proposal }
...
exports.handler = async (event) => {
  ...
  const prompt = `You are a professional Arizona government contract proposal writer. Write a compelling, professional proposal response for the following opportunity.
...
BID OPPORTUNITY:
- Title: ${bid.title}
- Issuing Agency: ${bid.agency || 'Arizona State Agency'}
...
Arizona-specific: reference Arizona Procurement Code compliance, DVBE/SBE/MBE participation where applicable, alignment with Arizona Executive Orders, and state agency-specific requirements.

Keep it professional, Arizona government-appropriate, and tailored to the specific bid. Use "we" and reference ${business} by name. Mark placeholders with [PLACEHOLDER] so the team knows to customize.`;
