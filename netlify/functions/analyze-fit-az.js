'use strict';
// CalGCC â€” Arizona Bid Analyze Fit (Claude Haiku)
// POST { bid, profile } â†’ { ok, analysis: { score, recommendation, summary, strengths, risks, requirements, next_steps } }
...
exports.handler = async (event) => {
  ...
  const prompt = `You are a Arizona government contract specialist helping ${businessName} evaluate a bid opportunity.
...
BID OPPORTUNITY:
- Title: ${bid.title}
- Agency: ${bid.agency || 'Arizona State Agency'}
...
{
  "score": <number 0-100 â€” must align with recommendation: GO=70-100, REVIEW=40-69, NO-GO=0-39>,
...
Scoring rules â€” follow strictly:
...
Arizona-specific considerations: DVBE equivalents (Service-Disabled Veteran-Owned, Minority-Owned, Women-Owned Small Business), Arizona Procurement Code compliance, Maricopa County local preference, Arizona State University and ASU system procurement requirements, prevailing wage for construction.
